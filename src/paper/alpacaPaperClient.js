...
// - Orders are single-leg only: equity MARKET (buy/sell) and single option
//   contract LIMIT (buy to open long calls/puts, sell to close). No
//   bracket/stop/trailing, no spreads, no multi-leg, no uncovered writes.
//
